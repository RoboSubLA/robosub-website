  ...
  return (
    <Layout>
      ...
      <div className={styles.pageWrapper}>
        ...
        <h1 style={{ fontSize: "4rem" }}> Actuated Systems</h1>
        <p>
          ...
          life. Finite Element Analyses (FEAs) and Computational Fluid Dynamics (CFDs) are produced to ensure the proper performance of
          the system was it will be underwater. Additionally, the Actuated Systems team works together with the computer
