...
import { Grid, Box, Card, CardMedia, CardContent, CardActions, Typography, Chip, Button } from '@mui/material';
    ...
    return(
        ...
        <Card className={styles.subCard} sx={{ maxWidth: 600 }}>
          ...
          <CardContent className={styles.subCardContent}>
            ...
            <Typography className={styles.subTeam}  style={{textAlign: "center"}} variant="body2" color="text.secondary">
              {sub.team}
            </Typography>
          </CardContent>
        </Card>
...
const RankingChips = ({rankings}) => {
  return(
    <div className={styles.chipContainer}>
      <Chip className={styles.rankingChip} label={"Overall: "+rankings.overall}/>
  ...
  return array.map((sub) => {
    return(
      <div class={styles.showcaseSubscontainer}>
        <img className={styles.showcaseImg} src={require('@site/static/img/auv/'+sub.subImg).default}/>
        <div class={styles.showcaseOverlay}>
          <div class={styles.overlayText}>
            <Typography className={styles.overlaySubName} gutterBottom variant="h5" component="div">
              {sub.subName}
            </Typography>
            <Typography className={styles.overlaySubTeam} variant="body2" color="text.secondary">
              {sub.team}
            </Typography>
          </div>
        </div>
...
const GenerateFleetShowcase = () => {
  ...
  return(
    <div>
      ...
      <div className={styles.chipContainer}>
        <Chip className={styles.rankingChipShowcase} label={"Overall: "+showcaseSubs.rankings.overall}/>
  ...
  return (
    <Layout>
      <div className={styles.fleetHeader}>
        <h1 className={styles.fleetTitle} style={{textAlign: "center"}}>Fleet Showcase</h1>
